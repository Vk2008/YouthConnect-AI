...
try:
    ...
    for message in api_response['data']['messages']:
        ...
        if received_mess == 'A':
            ...
            message = SmsMessage(source = 'python', body='Please enter the number that matches your top priority', to ='')
        ...
        message = SmsMessage(source = 'python', body='Thank you for sharing your opinion! Remember, your voice matters!', to ='')
